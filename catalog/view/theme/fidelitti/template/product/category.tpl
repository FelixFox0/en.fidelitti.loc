...
<div class="breadcrumbs">
    <nav class="row">
        ...
        <div class="large-6">
        <div class="sub_category__filter_two">
          <div class="sub_category__filter_even">
            ФИЛЬТР <span>+</span>
          </div> 
          <div class="sub_category__sort_even">
...
-->
    ...
    <div class="row sub_filter">
      ...
      <div class="large-12 sub_filter_hover" style="display: none; top:0;">
        ...
        <?php $class = 'col-sm-12'; ?>
        <?php } ?>
        <span class="sub_filter_close">Закрыть</span>
      </div>


      <div style="display: none; top:32px;" class="form-group input-group input-group-sm sub_sort_hover">
  ...
  <div id="filter-list"></div>
    ...
    <div id="text-popup__cat--view" class="white-popup mfp-hide">
        ...
        <div class="product-list large-4 medium-4 small-6 columns sub_category__product aproduct">
          ...
          <!--
           ...
           <span><?php echo $button_wishlist; ?></span>
            ...
            -->
            <a href="<?php echo $product['href']; ?>">
            <img src="<?php echo $product['thumb']; ?>" alt="" class="lazy-load sub_category__product--img">
            </a>
            <div class="dop_img">
            <a href="<?php echo $product['href']; ?>">
    ...
    <? } ?>
      ...
      <div id="ajax-button" class="product-list large-4 medium-4 small-6 columns sub_category__product">
        <a class="abjmax btn btn-product" onclick="aj();">
          <p>Показать еще <?php echo (($totalproducts - ($page * $limit)) > $limit) ? $limit : ($totalproducts - ($page * $limit)); ?></p>
        </a>
      </div>
      ...
      <div style="display:none" id="apage"><?php echo $page; ?></div>        
        <?php } ?>
    </div> 
...
<style type="text/css">
  .brainyfilter-panel .bf-c-1 input{
    display: none;
  }
  .brainyfilter-panel .bf-c-1{
