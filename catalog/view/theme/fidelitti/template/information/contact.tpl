...
if($(this).val()==""){$('.enq').html('<p ng-message="required" class="alert alert-danger ng-scope"><?php echo $error_enquiry_name; ?></p>')}
 ...
 <!--             <div class="text-danger"><?php echo $error_enquiry; ?></div>-->
       ...
       <div class="large-12">
        ...
        по телефону<br><br>
        +38 093 170 21 16 <br><br>
        <span><p>Для клиентов интернет-магазина служба доступна с понедельника по пятницу,
          с 9.30 до 18.30 часа, и с 10 до 18 часа по выходным<br>
          UTC+03:00</p></span></p>

           <p class="text-muted details"><strong>Телефон интернет магазина</strong></p>
