<?php echo $header; ?>
<div class="row clientService data-default">        
   <!--<div class="large-12 columns clientService__title">
    <?php echo $heading_title; ?>          
  </div>-->  
  <div id="content" class="ff large-12 columns clientService__right">
  <? if($information_id == 18) {?>
    <?php echo $content_bottom; ?>
    <?php echo $column_right; ?>
    <?php if ($actual_language == "ru-ru"){ ?>
      <div class="clientService__name">
        Свяжитесь с нашим клиентским сервисом
      </div>
      <div class="clientService__info">
        <div class="clientService_desc">
          Наши консультанты помогут Вам с любым вопросом
        </div>
        <div class="clientService__phone">
          <a href="tel:0800210385">
            <img src="/catalog/view/theme/mobile_theme/images/phone.png"> <span>Телефон</span>
            <div class="clientService__stringone">
              Звоните нам бесплатно 7 дней в неделю <br>с 9:30 до 18:30 <br>
              В субботу 
              с 10:00 до 18:00
            </div>
            <div class="clientService__stringtwo">
              +38 093 170 21 16
            </div>
            <div class="clientService-arrow"></div>
          </a>
        </div>
        <a href="/contact-us">
          <div class="clientService__email">                            
              <img src="/catalog/view/theme/mobile_theme/images/mail.png"> <span>Email</span>
              <div>
        ...
        <a href="/faq">
          <div class="clientService__faq">
            <img src="/catalog/view/theme/mobile_theme/images/questionmark.png"> 
            FAQ
            <div>
              Ответы на вопросы
            </div>
      ...
      <div class="clientService-dop_links">
        <a href="/statse_alll">
          <img src="/catalog/view/theme/mobile_theme/image/shopper3.png"> Доставка <div class="clientService-dop_links-go"></div>
        </a>
        <a href="/statse_alll">
          <img src="/catalog/view/theme/mobile_theme/image/ccard3.png"> Оплата <div class="clientService-dop_links-go"></div>
        </a>
        <a href="/statse_alll">
          <img src="/catalog/view/theme/mobile_theme/image/exchange2.png"> Возврат и обмен <div class="clientService-dop_links-go"></div>
        </a>
        <a href="/faq/">
          Часто задаваемые вопросы <div class="clientService-dop_links-go"></div>
        </a>
        </div>
  ...
  <? }elseif($information_id == 19) {?>
       <ul class="accordion" data-accordion data-allow-all-closed="true" data-responsive-accordion-tabs="accordion medium-tabs large-accordion" id="3e5nyv-responsiveaccordiontabs">
                <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Политика cookies</a>
...
color:#0A0A0A;mso-fareast-language:RU"><o:p></o:p></span></p><p class="MsoNormal" style="line-height: normal; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">
                 ...
                 <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Политика конфидециальности</a>
                  <div class="accordion-content" data-tab-content>
...
&quot;Times New Roman&quot;;color:#0A0A0A;mso-fareast-language:RU"><o:p></o:p></span></p><p class="MsoNormal" style="line-height: normal; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">
                 ...
                 <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Возврат и обмен</a>
                  <div class="accordion-content" data-tab-content>
...
mso-fareast-language:RU"><o:p>&nbsp;</o:p></span></p><p>
                 ...
                 <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Доставка</a>
                  <div class="accordion-content" data-tab-content>
...
mso-fareast-font-family:&quot;Times New Roman&quot;"><o:p></o:p></span></p>'></span>
                 ...
                 <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Оплата</a>
                  <div class="accordion-content" data-tab-content>
                        <span class="prmn-cmngr-message" data-key="oplata" data-default='<p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;line-height:
normal"><span style="font-size: 14pt; font-family: GothamPro, serif;">При доставке по России Вы можете оплатить заказ:</span><span style="font-size:14.0pt;font-family:&quot;Times New Roman&quot;,serif;mso-fareast-font-family:
&quot;Times New Roman&quot;;mso-fareast-language:RU"><o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo1;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">банковской картой Сбербанк<o:p></o:p></span></p><p class="MsoNormal" style="line-height: normal; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">
...
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo1;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">оплата при помощи онлайн платежей</span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo1;tab-stops:list 36.0pt"><span style="font-size: 14pt; font-family: GothamPro, serif;"><o:p><br></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo1;tab-stops:list 36.0pt"><span style="font-size: 14pt; font-family: GothamPro, serif;"><o:p><br></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l1 level1 lfo1;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">Определившись с покупкой, выберете вид оплаты
«Онлайн платеж» .<o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l1 level1 lfo1;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">Наш менеджер наберет Вас и предложит
наиболее удобный способ оплаты онлайн.<o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l2 level1 lfo3;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">После подтверждения выбранного Вами
способа оплаты,Вам придет на почту ссылка для совершения процедуры онлайн
оплаты.</span><span style="font-size: 8.5pt; font-family: GothamPro, serif;"> </span><span style="font-size: 14pt; font-family: GothamPro, serif;">На странице платежного шлюза введите
следующие реквизиты:<o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:45.0pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo2;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">номер карты<o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:45.0pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo2;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">срок действия карты<o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:45.0pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
mso-list:l0 level1 lfo2;tab-stops:list 36.0pt"><!--[if !supportLists]--><span style="font-size: 10pt; font-family: Symbol;">·<span style="font-variant-numeric: normal; font-stretch: normal; font-size: 7pt; line-height: normal; font-family: &quot;Times New Roman&quot;;">&nbsp;&nbsp;
</span></span><!--[endif]--><span style="font-size: 14pt; font-family: GothamPro, serif;">CVV / CVC код<o:p></o:p></span></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;line-height:normal"><span style="font-size: 14pt; font-family: GothamPro, serif;">и нажмите кнопку “Продолжить/Оплатить”.<o:p></o:p></span></p><p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;line-height:
normal"><span style="font-size: 14pt; font-family: GothamPro, serif;">&nbsp;&nbsp; <o:p></o:p></span></p><p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;line-height:
normal"><span style="font-size: 14pt; font-family: GothamPro, serif;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; После на
странице высветится информация о состоянии оплаты.</span><span style="font-size:14.0pt;font-family:&quot;Times New Roman&quot;,serif;mso-fareast-font-family:
&quot;Times New Roman&quot;;mso-fareast-language:RU"><o:p></o:p></span></p><p class="MsoNormal">&nbsp; <o:p></o:p></p><p class="MsoNormal" style="margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:22.5pt;margin-bottom:.0001pt;text-indent:-18.0pt;line-height:normal;
...
</p><p class="MsoNormal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Обращаем Ваше
внимание, <span style="font-size: 10.5pt; line-height: 107%; font-family: Helvetica, sans-serif; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">Поскольку основная валюта нашего магазина
украинская гривна, а </span><span style="font-size: 10.5pt; line-height: 107%; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="font-size: 10.5pt; line-height: 107%; font-family: Helvetica, sans-serif; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">выставляемый счет в </span><span style="font-size: 10.5pt; line-height: 107%; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">долларах</span><span style="font-size: 10.5pt; line-height: 107%; font-family: Helvetica, sans-serif; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;"> (</span><span style="font-size: 10.5pt; line-height: 107%; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">евро,</span><span style="font-size: 10.5pt; line-height: 107%; font-family: Helvetica, sans-serif; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;"> </span><span style="font-size: 10.5pt; line-height: 107%; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">рублях</span><span style="font-size: 10.5pt; line-height: 107%; font-family: Helvetica, sans-serif; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;"> и другие), сумма в </span><span style="font-size: 10.5pt; line-height: 107%; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">долларах
</span><span style="font-size: 10.5pt; line-height: 107%; font-family: Helvetica, sans-serif; color: rgb(10, 10, 10); background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial;">пересчитывается по курсу Вашего Банка для
покупки гривны. Оплачивая выставленный нами счет, Вы соглашаетесь, что итоговая
сумма может быть пересчитана по курсу вашего банка на момент оплаты в гривневом
эквиваленте.</span><o:p></o:p></p>'></span>
                  </div>
                </li>
        </ul>
  ...
  <? }elseif($information_id == 21) {?>
      ...
      <div class="our_production_two">
        <div class="large-12">
          ...
          <div class="our_production_two_text">
            На каждой ступени изготовления, наши изделия проходят жесткий контроль качества. Отлаженная модель производства. Своевременный выпуск готовых изделий. Современное оборудование. Вот условия нужные для передового производства.
          </div>
          </div>
      </div>
      <div class="our_production_trhee">
      <div class="large-12 our_production_trhee_one">
         <div class="our_production_trhee__title">РАСКРОЙНЫЙ</div>
         <div class="our_production_trhee__text">
          ЦЕХ №1<br>
          Для производства используем только лучшую лицевую кожу. Используем различные методики раскроя для достижения наилучшего результата.
          </div>
      </div>
      <div class="large-12">
      ...
      <div class="large-12">
        <div class="large-12 our_production_trhee_one">
         <div class="our_production_trhee__title">ЗАГОТОВИТЕЛЬНЫЙ</div>
         <div class="our_production_trhee__text">
          ЦЕХ №2<br>
      ...
      <div class="large-12 our_production_trhee_one">
         ...
         <div class="our_production_trhee__text">
          ЦЕХ №3<br>
          Контролируем каждый стежок строчки. Нитки и фурнитуру покупаем исключительно в Италии.
          </div>
      </div>
      <div class="large-12">
      ...
      <div class="large-12 our_production_trhee_one">
         ...
         <div class="our_production_trhee__text">
          ЦЕХ №4
          Цех, где происходят чудеса. Наши изделия обрабатываются исключительно итальянскими красками.
          </div>
      </div>     
      <div class="large-12">
