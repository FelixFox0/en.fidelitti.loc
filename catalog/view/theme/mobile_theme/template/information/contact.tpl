...
<div class="row clientService"> 
    ...
    <div id="content" class="large-12 clientService__right">
          ...
          <div class="form-group required">
            <div class="col-sm-10">
              ...
              <select name="select_category">
                ...
                <option value="Общая информация о Furla и нашей продукции">Общая информация о Furla и нашей продукции</option>
      ...
      <div class="large-12">
        ...
        по телефону <br><br>
        <span class="prmn-cmngr-message" data-key="phone"></span> <br><br><br><br>
        <span><p>Для клиентов интернет-магазина служба доступна с понедельника по пятницу,
          с 9.30 до 18.30 часа, и с 10 до 18 часа по выходным  UTC+03:00</p></span></p>
        Для клиентов интернет-магазина служба доступна с понедельника по пятницу, 24 рабочих часов
      </div>
        </div>
